        ...
        >
          ...
          >
            ...
            <button 
              ...
              className="px-8 py-4 bg-emerald-900/50 backdrop-blur-sm hover:bg-emerald-800/80 transition duration-200 rounded-full text-white font-semibold border border-emerald-700/50 transform hover:scale-105"
            >
              <span className="flex items-center gap-2">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
