...
exports.EIP712_DOMAIN_BY_NETWORK = exports.NETWORK_REGISTRY = void 0;
const payment_header_js_1 = require("../lib/utils/payment.header.js");
const facilitator_interface_js_1 = require("./facilitator.interface.js");
/**
...
exports.NETWORK_REGISTRY = {
     ...
     */
    [facilitator_interface_js_1.CronosNetwork.CronosMainnet]: {
        /** Default ERC-20 asset for mainnet X402 payments (USDCe). */
        asset: facilitator_interface_js_1.Contract.USDCe,
        /**
         ...
         */
        headerGenerator: payment_header_js_1.generateCronosPaymentHeader,
     ...
     */
    [facilitator_interface_js_1.CronosNetwork.CronosTestnet]: {
        /** Default ERC-20 asset for testnet X402 payments (USDCe test deployment). */
        asset: facilitator_interface_js_1.Contract.DevUSDCe,
 ...
 * ```
 */
exports.EIP712_DOMAIN_BY_NETWORK = {
    [facilitator_interface_js_1.CronosNetwork.CronosMainnet]: {
        name: facilitator_interface_js_1.AssetName.USDCe,
        version: '2',
    },
    [facilitator_interface_js_1.CronosNetwork.CronosTestnet]: {
        name: facilitator_interface_js_1.AssetName.USDCe,
