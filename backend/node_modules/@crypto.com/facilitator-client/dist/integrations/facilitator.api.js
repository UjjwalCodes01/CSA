...
const facilitator_guards_js_1 = require("./facilitator.guards.js");
/**
 ...
 * ```
 */
async function getSupported(baseUrl) {
    ...
    (0, facilitator_guards_js_1.assertX402SupportedResponse)(payload);
    return payload;
}
/**
 ...
 * ```
 */
async function verifyPayment(baseUrl, body) {
    ...
    (0, facilitator_guards_js_1.assertX402VerifyResponse)(payload);
    return payload;
}
/**
 ...
 * ```
 */
async function settlePayment(baseUrl, body) {
    ...
    (0, facilitator_guards_js_1.assertX402SettleResponse)(payload);
    return payload;
}
