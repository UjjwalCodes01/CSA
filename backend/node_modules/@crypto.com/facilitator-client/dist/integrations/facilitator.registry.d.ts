 ...
 * ```
 */
export declare const NETWORK_REGISTRY: {
    /**
    ...
    readonly "cronos-mainnet": {
         ...
         */
        readonly headerGenerator: typeof generateCronosPaymentHeader;
        /** Public JSON-RPC endpoint for Cronos EVM Mainnet. */
        readonly rpc_url: "https://evm.cronos.org";
    };
    /**
 ...
 * ```
 */
export declare const EIP712_DOMAIN_BY_NETWORK: Record<CronosNetwork, {
    name: string;
    version: string;
}>;
