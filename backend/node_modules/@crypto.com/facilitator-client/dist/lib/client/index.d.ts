...
import { ClientConfig, CronosNetwork, X402SupportedResponse, X402VerifyResponse, X402SettleResponse, PaymentRequirements, VerifyRequest, X402OutputSchema, Contract } from "../../integrations/facilitator.interface.js";
/**
 * @class Facilitator
 * @classdesc
...
export declare class Facilitator {
     ...
     * ```
     */
    getSupported(): Promise<X402SupportedResponse>;
    /**
     ...
     * ```
     */
    verifyPayment(request: VerifyRequest): Promise<X402VerifyResponse>;
    /**
     ...
     * ```
     */
    settlePayment(request: VerifyRequest): Promise<X402SettleResponse>;
    /**
