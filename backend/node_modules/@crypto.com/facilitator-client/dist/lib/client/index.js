...
const facilitator_api_js_1 = require("../../integrations/facilitator.api.js");
const payment_requirements_js_1 = require("../utils/payment.requirements.js");
const facilitator_registry_js_1 = require("../../integrations/facilitator.registry.js");
const payment_header_js_1 = require("../utils/payment.header.js");
/**
 * @constant
 ...
 * @private
 */
const FACILITATOR_BASE_URL = 'https://facilitator.cronoslabs.org';
/**
 * @class Facilitator
 * @classdesc
...
class Facilitator {
    ...
    constructor(config) {
        ...
        const registryConfig = facilitator_registry_js_1.NETWORK_REGISTRY[this.network];
        if (!registryConfig) {
     ...
     */
    async getSupported() {
        return await (0, facilitator_api_js_1.getSupported)(this.baseUrl);
    }
    /**
    ...
    async verifyPayment(request) {
        return await (0, facilitator_api_js_1.verifyPayment)(this.baseUrl, request);
    }
    /**
    ...
    async settlePayment(request) {
        return await (0, facilitator_api_js_1.settlePayment)(this.baseUrl, request);
    }
    /**
    ...
    async generatePaymentHeader(options) {
        return await (0, payment_header_js_1.generateCronosPaymentHeader)({
    ...
    generatePaymentRequirements(options) {
        return (0, payment_requirements_js_1.generatePaymentRequirements)({
            network: this.network,
            payTo: options.payTo,
            asset: options.asset ?? this.defaultAsset,
     ...
     * ```
     */
    buildVerifyRequest(paymentHeader, paymentRequirements) {
        return {
            x402Version: 1,
            paymentHeader,
            paymentRequirements,
