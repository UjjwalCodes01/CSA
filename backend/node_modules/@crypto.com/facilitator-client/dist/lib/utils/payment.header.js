...
exports.decodePaymentHeader = exports.encodePaymentHeader = exports.buildEip3009Header = exports.randomNonceHex32 = void 0;
exports.generateCronosPaymentHeader = generateCronosPaymentHeader;
const node_crypto_1 = __importDefault(require("node:crypto"));
const ethers_1 = require("ethers");
const facilitator_interface_js_1 = require("../../integrations/facilitator.interface.js");
const facilitator_registry_js_1 = require("../../integrations/facilitator.registry.js");
/**
...
const randomNonceHex32 = () => {
    ...
    return '0x' + node_crypto_1.default.randomBytes(32).toString('hex');
};
exports.randomNonceHex32 = randomNonceHex32;
/**
 ...
 * ```
 */
const buildEip3009Header = (payload, network) => ({
    x402Version: 1,
    scheme: facilitator_interface_js_1.Scheme.Exact,
    network,
    payload,
});
exports.buildEip3009Header = buildEip3009Header;
/**
 ...
 * ```
 */
const encodePaymentHeader = (header) => {
 ...
 * ```
 */
const decodePaymentHeader = (base64String) => {
 ...
 * ```
 */
async function generateCronosPaymentHeader(params) {
    const { signer, network, to, value, asset, validAfter, validBefore } = params;
    const config = facilitator_registry_js_1.NETWORK_REGISTRY[network];
    if (!config)
        throw new Error(`Unsupported network: ${network}`);
    const provider = 'provider' in signer && signer.provider ? signer.provider : new ethers_1.ethers.JsonRpcProvider(config.rpc_url);
    ...
    const nonce = (0, exports.randomNonceHex32)();
    const tokenAddress = asset ?? config.asset;
    if (!tokenAddress) {
        throw new Error('Token asset address is required (no default configured)');
    }
    const { name, version } = facilitator_registry_js_1.EIP712_DOMAIN_BY_NETWORK[network];
    const domain = {
        name,
        version,
        chainId: chainId,
    ...
    const header = (0, exports.buildEip3009Header)(payload, network);
    return (0, exports.encodePaymentHeader)(header);
}
