import { Contract, CronosNetwork, PaymentRequirements, X402OutputSchema } from "../../integrations/facilitator.interface.js";
/**
 ...
 * ```
 */
export declare const generatePaymentRequirements: (options: {
