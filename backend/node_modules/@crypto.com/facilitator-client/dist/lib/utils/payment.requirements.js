...
exports.generatePaymentRequirements = void 0;
 ...
 * ```
 */
const generatePaymentRequirements = (options) => {
    const { network, payTo, asset, description = "X402 payment request", maxAmountRequired = "1000", mimeType = "application/json", maxTimeoutSeconds = 300, resource, extra, outputSchema, } = options;
...
exports.generatePaymentRequirements = generatePaymentRequirements;
