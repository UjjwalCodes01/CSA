...
import { Eip3009Payload, CronosNetwork, Eip3009PaymentHeader, Contract } from "../../integrations/facilitator.interface.js";
/**
 ...
 * ```
 */
export declare const randomNonceHex32: () => string;
/**
 ...
 * ```
 */
export declare const buildEip3009Header: (payload: Eip3009Payload, network: CronosNetwork) => Eip3009PaymentHeader;
/**
 ...
 * ```
 */
export declare const encodePaymentHeader: (header: Eip3009PaymentHeader) => string;
/**
 ...
 * ```
 */
export declare const decodePaymentHeader: (base64String: string) => string;
/**
 ...
 * ```
 */
export declare function generateCronosPaymentHeader(params: {
